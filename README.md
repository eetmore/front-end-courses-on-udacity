...
The courses below are on udacity.com and I've tried to organize them in an order that seems reasonable. I'm not a developer and the orginaziton might be poor due to my lack of understanding, so use it out of order as you see fit.

1. [itnro to html and css](https://www.udacity.com/course/intro-to-html-and-css--ud001)
...
1. [web tooling and automation](https://www.udacity.com/course/web-tooling-automation--ud892)
...
1. [front end frameworks by google](https://www.udacity.com/course/front-end-frameworks--ud894)
1. [client server communication](https://www.udacity.com/course/client-server-communication--ud897)

### Additional courses

* [google maps api's](https://www.udacity.com/course/google-maps-apis--ud864)
